module github.com/danm-cni/danm
...
require (
	...
	github.com/k8snetworkplumbingwg/sriov-cni v1.1.1-0.20250716060549-6e57b33abf15
...
require (
	...
	github.com/k8snetworkplumbingwg/cni-log v0.0.0-20230801160229-b6e062c9e0f2 // indirect
